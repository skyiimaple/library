...
//		clients.jdbc(this.dataSource).clients(this.clientDetails());
		...
		/*
		clients.inMemory()
			.withClient("CskWebApp")  //客户端id
			.secret("CskWebApp")  //密码，要保密
			.accessTokenValiditySeconds(60)  //范文令牌有效期
			.refreshTokenValiditySeconds(60)  //刷新令牌有效期
			//授权客户端请求认证服务器的类型authorization_code：根据授权码生成令牌
...
//		oauthServer.checkTokenAccess("isAuthenticated()");  //检验token需要认证通过，可采用HTTP basic认证
